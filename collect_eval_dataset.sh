...
cd /bd_byta6000i0/users/jhu/pvr-generalization/robot-colosseum
source /bd_byta6000i0/users/jhu/miniconda3/bin/activate
...
SAVE_PATH=/bd_byta6000i0/users/jhu/pvr-generalization/colosseum_dataset
